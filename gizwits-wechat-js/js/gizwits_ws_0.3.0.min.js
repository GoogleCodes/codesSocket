...
//  登录到机智云
GizwitsWS.prototype._getUserLogin = function(uname,pword) {
    var me = this;
    ...
    $.ajax(url, {
        ...
        dataType: "json",
        data: "{\"username\":\"" + uname + "\",\"password\":\"" + pword + "\",\"lang\":\"en\"}"
    }).done(function(result) {
        console.log(result);
        me._userId = result.uid;
        me._userToken = result.token;
...
_getResetPassword = function(uname,pword) {
    var me = this;
    var url = "https://api.gizwits.com/app/reset_password";
    var num = 10;
    ...
    $.ajax(url, {
        ...
        dataType: "json",
        data: "{ \"phone\": \""+ uname +"\", \"new_pwd\": \""+ pword +"\", \"code\": \"456789\"}"
    }).done(function(result) {
        ...
        me._sendError("..." + evt.responseText)
    })
};
...
GizwitsWS.prototype._getBindingList = function(limit, skip) {
    ...
    $.ajax(url + query, {
        ...
        console.log(result);
        console.log(me._appId,me._userToken);
...
GizwitsWS.prototype._getDeleteList = function(did) {
    var me = this;
    var url = "https://{0}/app/bindings".format(me._apiHost);
    $.ajax(url, {
        type: "DELETE",
...
GizwitsWS.prototype._getModifyList = function(did,label,alias,remark) {
    var me = this;
    var url = "https://{0}/app/bindings".format(me._apiHost);
    $.ajax(url + "/" + did, {
        type: "PUT",
        ...
        data: "{\"dev_label\":[\""+ label +"\"],\"dev_alias\":\"" + alias + "\",\"remark\":\"" + remark + "\"}"
    }).done(function(result) {
        console.log(result);
    }).fail(function(evt) {
        me._bindingDevices = undefined;
...
Connection.prototype._onWSMessage = function(evt) {
    ...
    case "s2c_noti":
        ...
        if (conn._callbackObj.onReceivedAttrs && device) {
            ...
            $("#slider").val(res.data.attrs.hardwareVersion);
            $("#sliderSpan").text(res.data.attrs.hardwareVersion);
            console.log(res.data.attrs.hardwareVersion);
        }
        break;
...
function create() {
    var me = this;
    var url = "https://{0}/app/group".format(me._apiHost);
    $.ajax(url, {
        type: "POST",
        contentType: "application/json",
        headers: {
        ...
        dataType: "json",
        data: "{\"product_key\":\"" + me.product_key + "\",\"group_name\":\"" + "ThisMyName" + "\"}"
    }).done(function(result) {
        console.log(result);
    }).fail(function(evt) {
        me._sendError("Init error when getting user token: " + evt.responseText)
...
GizwitsWS.prototype.createThatTime = function(did) {
    var me = this;
    var url = "https://{0}/app/devices/".format(me._apiHost);

    var myDate = new Date();
    var y = myDate.getFullYear(),   //  年份
        m = myDate.getMonth(),      //  月份
        d = myDate.getDate();       //  当日
    var sDate = y + "-" + m + "-" + d;

    $.ajax(url + did + '/scheduler', {
        type: "POST",
        contentType: "application/json",
        headers: {
            "X-Gizwits-Application-Id": me._appId,
        ...
        me._timeid = result.id;
        console.log(result.id, me._timeid);
    }).fail(function(evt) {
        me._sendError("Init error when getting user token: " + evt.responseText)
    });
};

GizwitsWS.prototype._ModifyTiming = function(id) {
    var me = this;
    var url = "https://{0}/app/common_scheduler/".format(me._apiHost);
    $.ajax(url + id, {
        type: "POST",
        contentType: "application/json",
        headers: {
